...
namespace FastKMSWeb.Core.Service
{
    ...
    {       
        public async Task<Dictionary<string, object>> ExcelAsync(IBrowserFile file)
        {
            try
            {
        ...
        public async Task<Dictionary<string, object>> TextAync(IBrowserFile file)
        {
            try
            {
                var result = new Dictionary<string, object>();
        ...
        public async Task<Dictionary<string,object>> PdfAsync(IBrowserFile file)
        {
            try
            {
                var result = new Dictionary<string, object>();
        ...
        public async Task<Dictionary<string,object>> WordAsync(IBrowserFile file)
        {
            try
            {
                var result = new Dictionary<string, object>();
        ...
        public async Task<Dictionary<string,object>> ImageAsync(IBrowserFile file)
        {
            try
            {
                var result = new Dictionary<string, object>();
